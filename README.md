...
| **L1** 사이클 상태기 | 109개 테마 버킷의 6블록 상태벡터 — 망각·베이스·턴·밸류·**자본사이클**·펀더멘털 | 결정론 |
...
| [01-theme-universe](docs/01-theme-universe.md) | 3중 테마 정의 (industry + 큐레이션 + ETF 프록시), 109개 버킷 초안, 사이클 유형 분류 |
