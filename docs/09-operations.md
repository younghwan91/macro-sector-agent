...
| **분기** | 모순 감사(`03-macro-dag.md` §6) + 캘리브레이션 갱신(`10-validation.md`) | 사람 1시간 | 감사 리포트 |
...
| 최적화 infeasible | 제약 완화 순서를 **고정**: C2(ENB) → C3(집중도) → C1(MDD). MDD 는 마지막까지 지킨다 |
